...
class rs_solr_import extends \OxidEsales\Eshop\Application\Controller\Admin\AdminController
{
    ...
    public function importDelta()
    {
        //TODO: delta import
        /*
        SELECT oxarticles.oxtimestamp FROM `oxarticles`;
        select oxcategories.OXTIMESTAMP from oxcategories;
        select oxattribute.OXTIMESTAMP from oxattribute;
        select oxobject2attribute.OXTIMESTAMP from oxobject2attribute
         */
    }
